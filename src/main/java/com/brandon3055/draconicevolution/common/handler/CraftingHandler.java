...
public class CraftingHandler {
    ...
    public static void init() {
        ...
        final boolean DREAMCRAFT_NOT_PRESENT = !Loader.isModLoaded("dreamcraft");
        ...
        if (DREAMCRAFT_NOT_PRESENT) {
            ...
            add(
                    getStack(ModItems.chaosFragment, 1, 1),
                    "III",
                    "III",
                    "III",
                    'I',
                    getStack(ModItems.chaosFragment, 1, 0));
            add(
                    getStack(ModItems.chaosFragment, 1, 2),
                    "III",
                    "III",
                    "III",
                    'I',
            ...
            if (ModItems.isEnabled(ModItems.draconiumIngot) && ModItems.isEnabled(ModItems.draconiumDust)) {
                GameRegistry.addSmelting(
                        ...
                        getStack(ModItems.draconiumIngot, 1, 0),
                        1.0f);
            }
        ...
        // recipes to convert one energy relay to two half crystals and back
        addShaplessOre(
                getStack(ModBlocks.energyCrystal, 1, 0),
